 ...
 */
open class DetoksTrustChainCommunity(
    ...
    class Factory(
        ...
        private val crawler: TrustChainCrawler = TrustChainCrawler()
    ) : Overlay.Factory<DetoksTrustChainCommunity>(DetoksTrustChainCommunity::class.java) {
        override fun create(): DetoksTrustChainCommunity {
            return DetoksTrustChainCommunity(settings, database, crawler)
        }
    }
}
